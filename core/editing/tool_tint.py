...
class TintTool(EditingTool):
    def __init__(self): super().__init__(); self.value = 0
    @property
    def name(self) -> str: return "tint"
    @property
    def label(self) -> str: return "Оттенок"
    ...
    def apply(self, image: Image) -> Image:
        ...
        lim = self.value * 1.2
        # Усиление/ослабление зеленого канала для сдвига к зеленому/мадженте
        np_img[:, :, 1] += int(lim)
...
# --- END OF FILE core/editing/tool_tint.py ---