...
class ExposureTool(EditingTool):
    ...
    def apply(self, image: Image) -> Image:
        ...
        factor = pow(2, self.value / 100.0) # Более корректная формула экспозиции
...
# --- END OF FILE core/editing/tool_exposure.py ---