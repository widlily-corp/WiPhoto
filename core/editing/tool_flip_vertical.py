...
class FlipVerticalTool(EditingTool):
    def __init__(self): super().__init__()
    @property
    def name(self) -> str: return "flip_vertical"
    @property
    def label(self) -> str: return "Отразить по вертикали"
    ...
    def reset(self): pass
# --- END OF FILE core/editing/tool_flip_vertical.py ---