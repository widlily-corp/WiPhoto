...
class HighlightsTool(EditingTool):
    def __init__(self): super().__init__(); self.value = 0
    @property
    def name(self) -> str: return "highlights"
    @property
    def label(self) -> str: return "Света"
    ...
    def apply(self, image: Image) -> Image:
        ...
        # Применяем S-образную кривую к светлым участкам
        img_np = img_np - factor * (img_np - 128) * (img_np / 255.0) ** 2
...
# --- END OF FILE core/editing/tool_highlights.py ---