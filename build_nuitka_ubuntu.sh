#!/bin/bash
# ========================================
# WiPhoto v2.3.0 Ubuntu Build Script (Nuitka)
# ========================================

set -e  # Exit on error

echo "========================================"
echo "WiPhoto v2.3.0 Ubuntu Build with Nuitka"
echo "========================================"
echo ""
...
echo ""
echo "========================================"
echo "Building WiPhoto v2.3.0 with Nuitka..."
...
#!/bin/bash
set -e
echo "Installing WiPhoto v2.3.0..."
if [ "$EUID" -ne 0 ]; then
    exec sudo "$0" "$@"
fi
...
cd dist
tar -czf WiPhoto_v2.3.0_Linux.tar.gz WiPhoto_Linux/
cd ..

if [ -f "dist/WiPhoto_v2.3.0_Linux.tar.gz" ]; then
    echo ""
    echo "========================================"
    ...
    echo "Archive: dist/WiPhoto_v2.3.0_Linux.tar.gz"
    echo ""
    ls -lh dist/WiPhoto_v2.3.0_Linux.tar.gz
    echo ""
